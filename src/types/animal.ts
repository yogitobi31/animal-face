...
export type AnimalCard = { id: string; name: string; animalFamily: string; blend: string[]; rarity: 'common'|'rare'|'hidden'; imageUrl: string; profile: EmotionVector; catchphrase: string; description: string; keywords: string[]; colorMood: string; }
